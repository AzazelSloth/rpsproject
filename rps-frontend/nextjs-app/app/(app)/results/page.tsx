            ...
            <tbody>
              <tr className="border-t border-slate-100 align-top">
                ...
                <td className="px-6 py-4">
                  <Link
                    href={resultsHref}
                    className="inline-flex items-center justify-center rounded-[12px] border border-[#d5ba85] bg-[#181818] px-4 py-2 text-xs font-semibold text-white no-underline visited:text-white hover:text-white shadow-[0_12px_24px_rgba(24,24,24,0.12)] transition hover:-translate-y-0.5 hover:bg-[#242424]"
                  >
                    Voir les resultats
                  </Link>
                </td>
