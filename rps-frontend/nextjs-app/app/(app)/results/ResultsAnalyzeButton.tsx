...
export function ResultsAnalyzeButton({ campaignId }: { campaignId: number }) {
  ...
  return (
    <div className="flex max-w-[13rem] flex-col gap-1">
      <button
        ...
        className="inline-flex items-center justify-center rounded-[12px] bg-[#181818] px-4 py-2 text-xs font-semibold shadow-[0_12px_24px_rgba(24,24,24,0.12)] transition hover:-translate-y-0.5 hover:bg-[#242424] disabled:translate-y-0 disabled:opacity-60"
        style={{ color: "#ffffff" }}
      >
