...
export default async function ReportPage({
  ...
  const executiveSummaryTitle = getExecutiveSummaryTitle(
          ...
          <div className="space-y-5">
            ...
            <div className="rounded-[16px] border border-slate-200 p-5">
              ...
              <p className="mt-3 text-sm leading-7 text-slate-600">
                Stress moyen a {reportData.averageStress}/5, {reportData.alertCount} alertes
                detectees et plusieurs zones de vigilance a prioriser dans les equipes les plus
                exposees.
              </p>
              <div className="mt-4 rounded-[14px] bg-slate-50 px-4 py-4">
                ...
                <p className="mt-2 text-sm font-semibold text-slate-800">
                  {reportData.template.templateName}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="rounded-[16px] border border-slate-200 p-5">
              ...
              <div className="mt-3 space-y-3">
                {reportData.recommendations.map((item, index) => (
                  <div
                    key={item}
                    className="rounded-[14px] bg-slate-50 px-4 py-3 text-sm leading-6 text-slate-600"
                  >
