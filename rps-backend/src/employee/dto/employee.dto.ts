...
export class CreateEmployeeDto {
  ...
  @ApiProperty({ description: "Nom de famille de l'employe", example: 'Dupont' })
  @IsString()
  @MinLength(1)
  @MaxLength(100)
  @IsNotEmpty()
  ...
  @ApiProperty({ description: "Nom de l'entreprise de l'employe", example: 'Acme', required: false })
  @IsOptional()
  @IsString()
  @MaxLength(255)
  company_name?: string;

  @ApiProperty({ description: 'Numero de telephone', example: '0123456789', required: false })
  @IsOptional()
  @IsString()
  @MaxLength(50)
  phone?: string;

  @ApiProperty({ description: "Statut de l'employe", example: 'active', required: false })
  @IsOptional()
  @IsString()
  @MaxLength(50)
  status?: string;

  @ApiProperty({ description: "Departement de l'employe", example: 'IT', required: false })
  @IsOptional()
  @IsString()
  @MaxLength(100)
  department?: string;

  @ApiProperty({ description: "Token unique pour acceder au sondage", required: false })
  @IsOptional()
  @IsUUID()
  survey_token?: string;
}
...
export class UpdateEmployeeDto {
  ...
  @ApiProperty({ description: "Prenom de l'employe", example: 'Jean', required: false })
  @IsOptional()
  @IsString()
  @MinLength(1)
  @MaxLength(100)
  ...
  @ApiProperty({ description: "Nom de famille de l'employe", example: 'Dupont', required: false })
  @IsOptional()
  @IsString()
  @MinLength(1)
  @MaxLength(100)
  ...
  @ApiProperty({ description: "Adresse email de l'employe", example: 'jean.dupont@example.com', required: false })
  @IsOptional()
  @IsEmail()
  @MaxLength(255)
  email?: string;
...
export class ImportEmployeeRowDto {
  ...
  @ApiProperty({ description: "Nom de l'entreprise de l'employe", required: false })
  @IsOptional()
  @IsString()
  @MaxLength(255)
  company_name?: string;
