...
VALUES ('Admin Laroche', 'admin@laroche.fr', '$2b$10$rH0z9X.vKJH7qN8qN8qN8OYqZ9X.vKJH7qN8qN8qN8OYqZ9X.vKJH');
...
('Jean', 'Dupont', 'jean.dupont@laroche.fr', 'RH'),
('Marie', 'Martin', 'marie.martin@laroche.fr', 'IT'),
('Pierre', 'Bernard', 'pierre.bernard@laroche.fr', 'Finance'),
('Sophie', 'Petit', 'sophie.petit@laroche.fr', 'Marketing'),
('Lucas', 'Robert', 'lucas.robert@laroche.fr', 'Production'),
('Emma', 'Richard', 'emma.richard@laroche.fr', 'RH'),
('Thomas', 'Durand', 'thomas.durand@laroche.fr', 'IT'),
('Camille', 'Dubois', 'camille.dubois@laroche.fr', 'Finance'),
('Nicolas', 'Moreau', 'nicolas.moreau@laroche.fr', 'Marketing'),
('Julie', 'Laurent', 'julie.laurent@laroche.fr', 'Production');
